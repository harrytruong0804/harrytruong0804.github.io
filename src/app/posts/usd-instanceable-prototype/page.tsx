...
const post = getPost("usd-instanceable-prototype")!;

export const metadata = postMetadata("usd-instanceable-prototype");

export default function UsdInstanceablePrototypePage() {
  return (
    <>
