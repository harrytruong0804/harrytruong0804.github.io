...
const post = getPost("usd-composer-extension-from-scratch")!;

export const metadata = postMetadata("usd-composer-extension-from-scratch");

export default function UsdComposerExtensionFromScratchPage() {
  return (
    <>
