...
<div class="toc">
  ...
  <ol>
    <li><a href="#split">Authoring vs delivery: the first-principles split</a></li>
...
<!-- ───────────────────────── 1. SPLIT ───────────────────────── -->
<h2 id="split"><span class="step">1</span>Authoring vs delivery: the first-principles split</h2>
...
<div class="figure">
  <svg class="diagram" viewBox="0 0 780 300" role="img" aria-label="glTF three-part structure">
    <rect x="20" y="40" width="220" height="220" rx="12" fill="#fffbeb" stroke="#d97706"/>
    <text x="36" y="66" fill="#d97706" font-family="monospace" font-size="13" font-weight="700">.gltf  (JSON)</text>
    <text x="36" y="92" fill="#3a4252" font-size="12">scene graph + recipe:</text>
    <text x="36" y="114" fill="#6b7785" font-size="12">• scenes → nodes</text>
    <text x="36" y="134" fill="#6b7785" font-size="12">• meshes, materials</text>
    <text x="36" y="154" fill="#6b7785" font-size="12">• cameras, animations</text>
    <text x="36" y="174" fill="#6b7785" font-size="12">• accessors / views</text>
    <text x="36" y="206" fill="#6b7785" font-size="11">no raw vertex data —</text>
    <text x="36" y="222" fill="#6b7785" font-size="11">just pointers + offsets</text>

    <rect x="290" y="40" width="220" height="105" rx="12" fill="#eff6ff" stroke="#2563eb"/>
    <text x="306" y="66" fill="#2563eb" font-family="monospace" font-size="13" font-weight="700">.bin  (binary buffer)</text>
    <text x="306" y="92" fill="#3a4252" font-size="12">tightly packed bytes:</text>
    <text x="306" y="112" fill="#6b7785" font-size="12">vertex positions, normals,</text>
    <text x="306" y="130" fill="#6b7785" font-size="12">UVs, indices, anim keys</text>

    <rect x="290" y="160" width="220" height="100" rx="12" fill="#f0fdf4" stroke="#16a34a"/>
    <text x="306" y="186" fill="#16a34a" font-family="monospace" font-size="13" font-weight="700">textures</text>
    <text x="306" y="212" fill="#6b7785" font-size="12">PNG / JPG, or compressed</text>
    <text x="306" y="230" fill="#6b7785" font-size="12">KTX2 / Basis (GPU-ready)</text>

    <rect x="560" y="40" width="200" height="220" rx="12" fill="#f0fdf4" stroke="#16a34a" stroke-dasharray="5"/>
    <text x="576" y="66" fill="#16a34a" font-family="monospace" font-size="13" font-weight="700">.glb  (one file)</text>
    <text x="576" y="92" fill="#3a4252" font-size="12">binary container that</text>
    <text x="576" y="110" fill="#3a4252" font-size="12">bundles JSON + bin +</text>
    <text x="576" y="128" fill="#3a4252" font-size="12">textures into a single</text>
    <text x="576" y="146" fill="#3a4252" font-size="12">download.</text>
    <text x="576" y="176" fill="#d97706" font-size="12" font-weight="700">★ This is what tiles</text>
    <text x="576" y="194" fill="#d97706" font-size="12" font-weight="700">  use — 1 request,</text>
    <text x="576" y="212" fill="#d97706" font-size="12" font-weight="700">  no extra round-trips.</text>

    <defs><marker id="gltf-ar" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6 Z" fill="#2563eb"/></marker></defs>
    <path d="M240 120 H290" stroke="#2563eb" stroke-width="2" marker-end="url(#gltf-ar)"/>
    <path d="M240 150 C265 200 265 200 290 205" stroke="#2563eb" stroke-width="2" fill="none" marker-end="url(#gltf-ar)"/>
    <path d="M510 150 H560" stroke="#16a34a" stroke-width="2" marker-end="url(#gltf-ar)"/>
  </svg>
...
<div class="figure">
  <svg class="diagram" viewBox="0 0 760 280" role="img" aria-label="buffer bufferView accessor indirection">
    <rect x="40" y="40" width="680" height="46" rx="8" fill="#eff6ff" stroke="#2563eb"/>
    <text x="52" y="60" fill="#2563eb" font-family="monospace" font-size="12" font-weight="700">buffer</text>
    <text x="52" y="76" fill="#6b7785" font-size="11">one long blob of bytes (the .bin) — the GPU upload is literally this, verbatim</text>

    <rect x="40" y="120" width="320" height="46" rx="8" fill="#f5f3ff" stroke="#7c3aed"/>
    <text x="52" y="140" fill="#7c3aed" font-family="monospace" font-size="12" font-weight="700">bufferView A</text>
    <text x="52" y="156" fill="#6b7785" font-size="11">bytes 0–4096: "the positions region"</text>
    <rect x="400" y="120" width="320" height="46" rx="8" fill="#f5f3ff" stroke="#7c3aed"/>
    <text x="412" y="140" fill="#7c3aed" font-family="monospace" font-size="12" font-weight="700">bufferView B</text>
    <text x="412" y="156" fill="#6b7785" font-size="11">bytes 4096–6000: "the indices region"</text>

    <rect x="40" y="200" width="320" height="56" rx="8" fill="#fffbeb" stroke="#d97706"/>
    <text x="52" y="222" fill="#d97706" font-family="monospace" font-size="12" font-weight="700">accessor 0 → POSITION</text>
    <text x="52" y="240" fill="#6b7785" font-size="11">"read view A as 24 × VEC3 float"</text>
    <rect x="400" y="200" width="320" height="56" rx="8" fill="#fffbeb" stroke="#d97706"/>
    <text x="412" y="222" fill="#d97706" font-family="monospace" font-size="12" font-weight="700">accessor 1 → indices</text>
    <text x="412" y="240" fill="#6b7785" font-size="11">"read view B as 36 × SCALAR ushort"</text>

    <defs><marker id="gltf-d" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto"><path d="M0,0 L7,3 L0,6 Z" fill="#6b7785"/></marker></defs>
    <path d="M200 120 V86" stroke="#6b7785" marker-end="url(#gltf-d)"/>
    <path d="M560 120 V86" stroke="#6b7785" marker-end="url(#gltf-d)"/>
    <path d="M200 200 V166" stroke="#6b7785" marker-end="url(#gltf-d)"/>
    <path d="M560 200 V166" stroke="#6b7785" marker-end="url(#gltf-d)"/>
  </svg>
...
<div class="figure">
  <svg class="diagram" viewBox="0 0 780 170" role="img" aria-label="glTF to MDL to RTX">
    <rect x="20" y="55" width="170" height="60" rx="10" fill="#fffbeb" stroke="#d97706"/>
    <text x="105" y="80" fill="#d97706" font-size="12" font-weight="700" text-anchor="middle">GLB tile</text>
    <text x="105" y="98" fill="#6b7785" font-size="10" text-anchor="middle">glTF PBR mesh</text>
    <rect x="300" y="55" width="170" height="60" rx="10" fill="#f5f3ff" stroke="#7c3aed"/>
    <text x="385" y="80" fill="#7c3aed" font-size="12" font-weight="700" text-anchor="middle">Cesium Native</text>
    <text x="385" y="98" fill="#6b7785" font-size="10" text-anchor="middle">decode → Fabric</text>
    <rect x="580" y="55" width="180" height="60" rx="10" fill="#f0fdf4" stroke="#16a34a"/>
    <text x="670" y="80" fill="#16a34a" font-size="12" font-weight="700" text-anchor="middle">RTX (MDL materials)</text>
    <text x="670" y="98" fill="#6b7785" font-size="10" text-anchor="middle">pixels</text>
    <defs><marker id="gltf-m" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6 Z" fill="#2563eb"/></marker></defs>
    <path d="M190 85 H300" stroke="#2563eb" stroke-width="2" marker-end="url(#gltf-m)"/>
    <path d="M470 85 H580" stroke="#2563eb" stroke-width="2" marker-end="url(#gltf-m)"/>
    <text x="300" y="150" fill="#6b7785" font-size="11">glTF PBR (metallic-roughness) is translated to MDL — same physical inputs, RTX shader.</text>
  </svg>
