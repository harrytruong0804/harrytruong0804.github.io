...
.artifact-scope /* ---------- HERO ---------- */
  .hero {padding:70px 0 60px; border-bottom:1px solid var(--at-line);}
...
.artifact-scope .subhead {
    margin-top:18px; font-size:clamp(1rem,2.4vw,1.15rem); color:var(--at-muted);
    max-width:56ch;
  }
...
.artifact-scope .hero-caption {
    margin-top:10px; font-family:var(--at-font-mono); font-size:12px; color:var(--at-muted);
    text-align:center;
  }
.artifact-scope /* ---------- FRAME (signature corner-bracket device) ---------- */
  .frame {position:relative; padding:26px; border:1px solid var(--at-line); border-radius:10px; background:var(--at-surface);}
.artifact-scope .corner {position:absolute; width:14px; height:14px; pointer-events:none;}
.artifact-scope .corner.tl {top:-1px; left:-1px; border-top:2px solid var(--at-blue); border-left:2px solid var(--at-blue); border-top-left-radius:3px;}
.artifact-scope .corner.tr {top:-1px; right:-1px; border-top:2px solid var(--at-blue); border-right:2px solid var(--at-blue); border-top-right-radius:3px;}
.artifact-scope .corner.bl {bottom:-1px; left:-1px; border-bottom:2px solid var(--at-blue); border-left:2px solid var(--at-blue); border-bottom-left-radius:3px;}
.artifact-scope .corner.br {bottom:-1px; right:-1px; border-bottom:2px solid var(--at-blue); border-right:2px solid var(--at-blue); border-bottom-right-radius:3px;}
.artifact-scope .frame.amber .corner {border-color:var(--at-amber);}
...
.artifact-scope .step-tag {
    font-family:var(--at-font-mono); font-size:12.5px; color:var(--at-blue);
...
.artifact-scope h2 {
    font-family:var(--at-font-display); font-weight:600; font-size:clamp(1.5rem,3.6vw,2rem);
    margin-top:14px; letter-spacing:-0.01em;
  }
.artifact-scope h3 {font-family:var(--at-font-display); font-weight:600; font-size:1.15rem; margin:28px 0 10px;}
...
.artifact-scope .definition {
    margin-top:22px; padding:20px 22px; border-left:2px solid var(--at-blue);
    background:linear-gradient(90deg, var(--at-blue-soft), transparent 60%);
    border-radius:0 8px 8px 0;
  }
.artifact-scope .definition.amber {border-left-color:var(--at-amber); background:linear-gradient(90deg, var(--at-amber-soft), transparent 60%);}
.artifact-scope .definition span.label {
    display:block; font-family:var(--at-font-mono); font-size:11.5px; letter-spacing:.1em;
    color:var(--at-blue); text-transform:uppercase; margin-bottom:6px;
  }
.artifact-scope .definition.amber span.label {color:var(--at-amber);}
.artifact-scope .definition p {color:var(--at-text); margin-top:0; max-width:none;}
...
.artifact-scope .code-label {
    font-family:var(--at-font-mono); font-size:11.5px; color:var(--at-muted);
    display:flex; justify-content:space-between; margin-bottom:10px; letter-spacing:.04em;
  }
.artifact-scope .code-label .dot {color:var(--at-accent);}
.artifact-scope pre {
    font-family:var(--at-font-mono); font-size:13px; line-height:1.65;
    overflow-x:auto; white-space:pre;
  }
.artifact-scope code .tok-keyword {color:var(--at-accent);}
.artifact-scope code .tok-string {color:var(--at-green);}
.artifact-scope code .tok-comment {color:var(--at-faint); font-style:italic;}
.artifact-scope code .tok-type {color:var(--at-violet);}
.artifact-scope code .tok-decorator {color:var(--at-amber);}
.artifact-scope .callout {
    margin-top:22px; padding:16px 18px; border:1px dashed var(--at-line);
    border-radius:8px; font-size:.92rem; color:var(--at-muted); position:relative;
  }
.artifact-scope .callout::before {
    content:'⚠ COMMON MIX-UP'; display:block; font-family:var(--at-font-mono);
    font-size:11px; letter-spacing:.08em; color:var(--at-accent); margin-bottom:8px;
  }
.artifact-scope .callout p {margin:0; color:var(--at-muted); max-width:none;}
...
.artifact-scope thead th {
    font-family:var(--at-font-mono); font-size:11.5px; letter-spacing:.08em; text-transform:uppercase;
    text-align:left; padding:12px 14px; color:var(--at-muted); border-bottom:1px solid var(--at-line);
  }
.artifact-scope thead th:nth-child(2) {color:var(--at-blue);}
.artifact-scope thead th:nth-child(3) {color:var(--at-amber);}
.artifact-scope tbody td {padding:14px; border-bottom:1px solid var(--at-line); vertical-align:top; color:var(--at-muted);}
.artifact-scope tbody td:first-child {color:var(--at-text); font-weight:600; width:26%;}
.artifact-scope tbody tr:hover {background:var(--at-surface);}
.artifact-scope .verdict {font-family:var(--at-font-mono); font-size:11px; padding:2px 8px; border-radius:100px; white-space:nowrap;}
.artifact-scope .verdict.yes {color:var(--at-green); background:var(--at-green-soft); border:1px solid var(--at-green);}
.artifact-scope .verdict.no {color:var(--at-accent); background:var(--at-accent-soft); border:1px solid var(--at-accent);}
.artifact-scope .verdict.kinda {color:var(--at-amber); background:var(--at-amber-soft); border:1px solid var(--at-amber);}
...
.artifact-scope .vs-card {padding:18px; background:var(--at-surface); border:1px solid var(--at-line); border-radius:8px;}
.artifact-scope .vs-card.win {border-color:var(--at-green);}
.artifact-scope .vs-card .k {font-family:var(--at-font-mono); font-size:11px; letter-spacing:.08em; text-transform:uppercase; color:var(--at-amber);}
.artifact-scope .vs-card.win .k {color:var(--at-green);}
.artifact-scope .vs-card ul {margin:10px 0 0 18px; font-size:.88rem; color:var(--at-muted);}
...
.artifact-scope .tree-root {
    ...
    border:1px solid var(--at-blue); border-radius:8px; background:var(--at-blue-soft);
    font-family:var(--at-font-display); font-weight:600; font-size:1.05rem;
  }
.artifact-scope .tree-root span {display:block; font-family:var(--at-font-mono); font-weight:400; font-size:11.5px;
    color:var(--at-muted); margin-top:4px; letter-spacing:.02em;}
.artifact-scope .tree-children {
    display:flex; flex-wrap:wrap; gap:16px; justify-content:center; margin-top:36px;
    padding-top:20px; border-top:1px solid var(--at-line); position:relative;
  }
.artifact-scope .tree-card {
    flex:1 1 150px; max-width:220px; position:relative; padding:14px 14px 16px;
    background:var(--at-surface); border:1px solid var(--at-line); border-radius:8px;
  }
.artifact-scope .tree-card::before {
    content:''; position:absolute; top:-21px; left:50%; transform:translateX(-50%);
    width:1px; height:20px; background:var(--at-line);
  }
.artifact-scope .tree-card.highlight {border-color:var(--at-amber); background:var(--at-amber-soft);}
.artifact-scope .tree-card.highlight::before {background:var(--at-amber);}
.artifact-scope .tree-card b {display:block; font-family:var(--at-font-display); font-size:.98rem; margin-bottom:6px;}
.artifact-scope .tree-card p {margin:0; font-size:.83rem; max-width:none; color:var(--at-muted);}
.artifact-scope /* decision list */
  .decision {margin-top:28px;}
.artifact-scope .decision-q {
    padding:16px 18px; background:var(--at-surface); border:1px solid var(--at-line);
    border-radius:8px; font-family:var(--at-font-mono); font-size:.88rem; color:var(--at-text);
  }
.artifact-scope .decision-branch {
    margin-left:22px; margin-top:10px; padding-left:18px; border-left:2px solid var(--at-line);
  }
.artifact-scope .decision-branch .tag {
    font-family:var(--at-font-mono); font-size:11px; padding:2px 8px; border-radius:100px;
    display:inline-block; margin-bottom:8px;
  }
.artifact-scope .decision-branch.yes .tag {color:var(--at-green); background:var(--at-green-soft); border:1px solid var(--at-green);}
.artifact-scope .decision-branch.no .tag {color:var(--at-accent); background:var(--at-accent-soft); border:1px solid var(--at-accent);}
.artifact-scope .decision-branch p {margin-top:4px; font-size:.88rem;}
.artifact-scope .decision-result {
    margin-top:8px; font-family:var(--at-font-mono); font-size:.85rem; padding:8px 12px;
    background:var(--at-inset); border-radius:6px; display:inline-block; color:var(--at-text);
  }
.artifact-scope /* tldr */
  .tldr {
    padding:30px; border-radius:12px;
    background:linear-gradient(135deg, var(--at-blue-soft), var(--at-amber-soft));
    border:1px solid var(--at-line);
  }
.artifact-scope .tldr h3 {margin-top:0; font-size:1.3rem;}
.artifact-scope .tldr p {color:var(--at-text); max-width:none;}
...
.artifact-scope .tldr .col {padding:16px; background:var(--at-surface); border-radius:8px;}
.artifact-scope .tldr .col .k {font-family:var(--at-font-mono); font-size:11px; letter-spacing:.08em; text-transform:uppercase;}
.artifact-scope .tldr .col:nth-child(1) .k {color:var(--at-blue);}
.artifact-scope .tldr .col:nth-child(2) .k {color:var(--at-amber);}
.artifact-scope .tldr .col p {margin-top:8px; font-size:.9rem; color:var(--at-muted);}
.artifact-scope .divider {height:1px; background:var(--at-line);}
.artifact-scope footer {
    border-top:1px solid var(--at-line); padding:34px 0 90px; margin-top:20px;
    font-family:var(--at-font-body); font-size:14px; color:var(--at-muted);
  }
.artifact-scope footer .tag {
    font-family:var(--at-font-mono); font-size:11.5px; letter-spacing:.1em;
    text-transform:uppercase; color:var(--at-accent);
  }
.artifact-scope footer p {color:var(--at-muted); max-width:none; margin-top:8px;}
`;

export const html = `
<div class="wrap">
  <header class="hero">
    <div class="eyebrow">SOFTWARE DESIGN</div>
    ...
    <div class="hero-diagram">
      <svg viewBox="0 0 700 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Diagram of a client with round pins that doesn't fit an adaptee with flat slots; an Adapter in the middle translates pay(49.99) into charge(4999)">
        <text x="350" y="24" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="10.5" text-anchor="middle">Two interfaces that don't match — and you can't change either side</text>
        <!-- client plug -->
        <g>
          <rect x="20" y="88" width="95" height="64" rx="8" fill="var(--at-blue-soft)" stroke="var(--at-blue)" stroke-width="1.5"/>
          <circle cx="123" cy="106" r="7" fill="var(--at-blue)"/>
          <circle cx="123" cy="134" r="7" fill="var(--at-blue)"/>
          <text x="67" y="115" fill="var(--at-blue)" font-family="var(--at-font-display)" font-weight="600" font-size="13" text-anchor="middle">Client</text>
          <text x="67" y="132" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">● round pins</text>
          <text x="67" y="176" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">speaks pay($, ccy)</text>
        </g>
        <!-- call in -->
        <line x1="132" y1="120" x2="268" y2="120" stroke="var(--at-blue)" stroke-width="1.5" marker-end="url(#heroArrowCyan)"/>
        <text x="200" y="108" fill="var(--at-blue)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">pay(49.99, "USD")</text>
        <!-- adapter -->
        <g>
          <rect x="272" y="72" width="156" height="96" rx="8" fill="var(--at-amber-soft)" stroke="var(--at-amber)" stroke-width="1.5" stroke-dasharray="5 3"/>
          <text x="350" y="108" fill="var(--at-amber)" font-family="var(--at-font-display)" font-weight="700" font-size="15" text-anchor="middle">ADAPTER</text>
          <text x="350" y="127" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">× 100, drop ccy</text>
          <text x="350" y="142" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">then delegate →</text>
        </g>
        <!-- call out -->
        <line x1="432" y1="120" x2="568" y2="120" stroke="var(--at-violet)" stroke-width="1.5" stroke-dasharray="4 4" marker-end="url(#heroArrowRed)"/>
        <text x="500" y="108" fill="var(--at-violet)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">charge(4999)</text>
        <!-- adaptee socket -->
        <g>
          <rect x="572" y="88" width="108" height="64" rx="4" fill="var(--at-violet-soft)" stroke="var(--at-violet)" stroke-width="1.5"/>
          <rect x="588" y="112" width="30" height="16" fill="var(--at-bg)" stroke="var(--at-violet)" stroke-width="1.5"/>
          <rect x="628" y="112" width="30" height="16" fill="var(--at-bg)" stroke="var(--at-violet)" stroke-width="1.5"/>
          <text x="626" y="106" fill="var(--at-violet)" font-family="var(--at-font-display)" font-weight="600" font-size="12" text-anchor="middle">Adaptee</text>
          <text x="626" y="176" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">speaks charge(cents)</text>
        </g>
        <defs>
          <marker id="heroArrowCyan" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="var(--at-blue)"/></marker>
          <marker id="heroArrowRed" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="var(--at-violet)"/></marker>
        </defs>
      </svg>
  ...
  <main class="article">
    ...
    <section id="delegation">
      ...
      <h2>What Delegation Actually Is</h2>
      <p>
      ...
      <div class="diagram">
        <svg viewBox="0 0 620 140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Client calls Car.start, Car delegates to Engine.start; the caller only ever sees Car">
          <rect x="10" y="45" width="120" height="50" rx="8" fill="var(--at-surface)" stroke="var(--at-muted)" stroke-width="1.3"/>
          <text x="70" y="75" fill="var(--at-text)" font-family="var(--at-font-mono)" font-size="12" text-anchor="middle">Client</text>

          <line x1="130" y1="70" x2="211" y2="70" stroke="var(--at-blue)" stroke-width="1.5" marker-end="url(#arrow1)"/>
          <text x="172" y="58" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">.start()</text>

          <rect x="215" y="35" width="150" height="70" rx="8" fill="var(--at-blue-soft)" stroke="var(--at-blue)" stroke-width="1.5"/>
          <text x="290" y="65" fill="var(--at-blue)" font-family="var(--at-font-display)" font-weight="600" font-size="13" text-anchor="middle">Car</text>
          <text x="290" y="83" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">self._engine</text>

          <line x1="365" y1="70" x2="466" y2="70" stroke="var(--at-blue)" stroke-width="1.5" stroke-dasharray="4 4" marker-end="url(#arrow1)"/>
          <text x="417" y="58" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">delegates →</text>

          <rect x="470" y="35" width="140" height="70" rx="8" fill="var(--at-surface)" stroke="var(--at-muted)" stroke-width="1.3"/>
          <text x="540" y="65" fill="var(--at-text)" font-family="var(--at-font-display)" font-weight="600" font-size="13" text-anchor="middle">Engine</text>
          <text x="540" y="83" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">.start()</text>

          <text x="290" y="128" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">← the Client's world ends here; it never learns Engine exists</text>

          <defs>
            <marker id="arrow1" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
              <path d="M0,0 L6,3 L0,6 Z" fill="var(--at-blue)"/>
            </marker>
          </defs>
        </svg>
      </div>
    ...
    <section id="adapter">
      ...
      <div class="diagram">
        <svg viewBox="0 0 620 175" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="StripeAdapter implements the PaymentProcessor target interface and wraps LegacyStripeClient, delegating pay() to charge()">
          <rect x="10" y="55" width="160" height="55" rx="8" fill="var(--at-blue-soft)" stroke="var(--at-blue)" stroke-width="1.5"/>
          <text x="90" y="78" fill="var(--at-blue)" font-family="var(--at-font-display)" font-weight="600" font-size="12.5" text-anchor="middle">PaymentProcessor</text>
          <text x="90" y="96" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">target interface</text>

          <!-- UML-style realization: dashed arrow FROM adapter TO interface -->
          <line x1="235" y1="82" x2="180" y2="82" stroke="var(--at-blue)" stroke-width="1.5" stroke-dasharray="5 4" marker-end="url(#arrowHollow)"/>
          <text x="207" y="70" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">implements</text>

          <rect x="235" y="45" width="160" height="75" rx="8" fill="var(--at-amber-soft)" stroke="var(--at-amber)" stroke-width="1.5" stroke-dasharray="5 3"/>
          <text x="315" y="75" fill="var(--at-amber)" font-family="var(--at-font-display)" font-weight="700" font-size="13.5" text-anchor="middle">StripeAdapter</text>
          <text x="315" y="93" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">.pay(amount, ccy)</text>
          <text x="315" y="108" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">translates &amp; delegates →</text>

          <line x1="395" y1="82" x2="456" y2="82" stroke="var(--at-violet)" stroke-width="1.5" stroke-dasharray="4 4" marker-end="url(#arrow3)"/>
          <text x="428" y="70" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">wraps</text>

          <rect x="460" y="55" width="160" height="55" rx="8" fill="var(--at-violet-soft)" stroke="var(--at-violet)" stroke-width="1.5"/>
          <text x="540" y="78" fill="var(--at-violet)" font-family="var(--at-font-display)" font-weight="600" font-size="12.5" text-anchor="middle">LegacyStripeClient</text>
          <text x="540" y="96" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9.5" text-anchor="middle">.charge(cents)</text>

          <text x="315" y="152" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">pay(49.99, "USD")  →  ×100, validate ccy  →  charge(4999)</text>

          <defs>
            <marker id="arrowHollow" markerWidth="10" markerHeight="10" refX="8" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 Z" fill="none" stroke="var(--at-blue)" stroke-width="1.2"/></marker>
            <marker id="arrow3" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="var(--at-violet)"/></marker>
          </defs>
        </svg>
      </div>
    ...
    <section id="hydra">
      ...
      <div class="diagram">
        <svg viewBox="0 0 620 260" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="HydraEngine delegates to SceneDelegate and RenderDelegate, each delegate wrapping its own adaptee">
          <rect x="210" y="10" width="200" height="52" rx="8" fill="var(--at-surface)" stroke="var(--at-muted)" stroke-width="1.3"/>
          <text x="310" y="34" fill="var(--at-text)" font-family="var(--at-font-display)" font-weight="600" font-size="13" text-anchor="middle">HydraEngine</text>
          <text x="310" y="50" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="9" text-anchor="middle">only knows two abstract interfaces</text>

          <line x1="260" y1="62" x2="150" y2="100" stroke="var(--at-blue)" stroke-width="1.5" marker-end="url(#arrowH1)"/>
          <text x="176" y="76" fill="var(--at-blue)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">pull scene data</text>
          <line x1="360" y1="62" x2="470" y2="100" stroke="var(--at-blue)" stroke-width="1.5" marker-end="url(#arrowH2)"/>
          <text x="446" y="76" fill="var(--at-blue)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">push draw calls</text>

          <rect x="40" y="100" width="180" height="60" rx="8" fill="var(--at-amber-soft)" stroke="var(--at-amber)" stroke-width="1.5" stroke-dasharray="5 3"/>
          <text x="130" y="122" fill="var(--at-amber)" font-family="var(--at-font-display)" font-weight="700" font-size="12.5" text-anchor="middle">UsdSceneDelegate</text>
          <text x="130" y="138" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">implements HdSceneDelegate</text>
          <text x="130" y="152" fill="var(--at-amber)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">(ADAPTER)</text>

          <rect x="400" y="100" width="180" height="60" rx="8" fill="var(--at-amber-soft)" stroke="var(--at-amber)" stroke-width="1.5" stroke-dasharray="5 3"/>
          <text x="490" y="122" fill="var(--at-amber)" font-family="var(--at-font-display)" font-weight="700" font-size="12.5" text-anchor="middle">RtxRenderDelegate</text>
          <text x="490" y="138" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">implements HdRenderDelegate</text>
          <text x="490" y="152" fill="var(--at-amber)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">(ADAPTER)</text>

          <line x1="130" y1="160" x2="130" y2="196" stroke="var(--at-violet)" stroke-width="1.5" stroke-dasharray="4 4" marker-end="url(#arrowH3)"/>
          <text x="180" y="182" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">wraps &amp; translates</text>
          <line x1="490" y1="160" x2="490" y2="196" stroke="var(--at-violet)" stroke-width="1.5" stroke-dasharray="4 4" marker-end="url(#arrowH4)"/>
          <text x="540" y="182" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">wraps &amp; translates</text>

          <rect x="40" y="200" width="180" height="50" rx="6" fill="var(--at-violet-soft)" stroke="var(--at-violet)" stroke-width="1.3"/>
          <text x="130" y="222" fill="var(--at-violet)" font-family="var(--at-font-display)" font-weight="600" font-size="12" text-anchor="middle">UsdStage</text>
          <text x="130" y="238" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">adaptee — raw USD data</text>

          <rect x="400" y="200" width="180" height="50" rx="6" fill="var(--at-violet-soft)" stroke="var(--at-violet)" stroke-width="1.3"/>
          <text x="490" y="222" fill="var(--at-violet)" font-family="var(--at-font-display)" font-weight="600" font-size="12" text-anchor="middle">RtxNativeEngine</text>
          <text x="490" y="238" fill="var(--at-muted)" font-family="var(--at-font-mono)" font-size="8.5" text-anchor="middle">adaptee — native render API</text>

          <defs>
            <marker id="arrowH1" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="var(--at-blue)"/></marker>
            <marker id="arrowH2" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="var(--at-blue)"/></marker>
            <marker id="arrowH3" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="var(--at-violet)"/></marker>
            <marker id="arrowH4" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="var(--at-violet)"/></marker>
          </defs>
        </svg>
      </div>
